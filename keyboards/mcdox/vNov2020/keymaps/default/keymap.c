...
`--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
  ...
  `----------------------------------'                                       `----------------------------------'
                                ...
                                ,------|------|------|       |------+------+------.
                                |      |      |      |       |      |      |      |
                                |LShift|LCtrl |  ~L2 |       | ~L2  | Enter| Space|
                                |      |      |      |       |      |      |      |
                                `--------------------'       `--------------------'
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_mcdoxNov2020(
    ...
    MO(1)   , KC_A    , KC_O    , KC_E    , KC_U    , KC_I    , KC_DEL  ,
    KC_BSPC , KC_SCLN , KC_Q    , KC_J    , KC_K    , KC_X    ,     KC_VOLU , KC_VOLD ,
    KC_GRV  , KC_HOME , KC_PGDN , KC_PGUP , KC_END  ,     KC_LSFT , KC_LCTL , MO(2)   ,

                    KC_F5   , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    , KC_SLSH ,
                    KC_LBRC , KC_F    , KC_G    , KC_C    , KC_R    , KC_L    , KC_EQL  ,
                    KC_RBRC , KC_D    , KC_H    , KC_T    , KC_N    , KC_S    , KC_MINS ,
    KC_APP  , KC_RGUI ,       KC_B    , KC_M    , KC_W    , KC_V    , KC_Z    , KC_RCTL ,
    MO(2)   , KC_ENT  , KC_SPC  ,       KC_LEFT , KC_UP   , KC_DOWN , KC_RGHT , KC_BSLS
  ),
  LAYOUT_mcdoxNov2020(
    _______ , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6   ,
    _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ , KC_INS  ,
    _______ , _______ , _______ , _______ , _______ , _______ ,     MAC0    , MAC1    ,
    ...
    _______ , _______ ,       _______ , KC_WH_L , KC_WH_U , KC_WH_D , KC_WH_R , _______ ,
    KC_NO   , _______ , _______ ,       KC_MS_L , KC_MS_U , KC_MS_D , KC_MS_R , _______
  ),
  LAYOUT_mcdoxNov2020(
    KC_SLSH , KC_0    , KC_9    , KC_8    , KC_7    , KC_6    , KC_F5   ,
    KC_EQL  , KC_L    , KC_R    , KC_C    , KC_G    , KC_F    , KC_LBRC ,
    KC_MINS , KC_S    , KC_N    , KC_T    , KC_H    , KC_D    , KC_RBRC ,
    KC_RCTL , KC_Z    , KC_V    , KC_W    , KC_M    , KC_B    ,     KC_LGUI , KC_MUTE ,
    KC_BSLS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT ,     KC_SPC  , KC_ENT  , _______ ,

                    KC_F4   , KC_5    , KC_4    , KC_3    , KC_2    , KC_1    , KC_ESC  ,
                    KC_LALT , KC_Y    , KC_P    , KC_DOT  , KC_COMM , KC_QUOT , KC_TAB  ,
                    KC_DEL  , KC_I    , KC_U    , KC_E    , KC_O    , KC_A    , _______ ,
    _______ , _______ ,       KC_X    , KC_K    , KC_J    , KC_Q    , KC_SCLN , KC_BSPC ,
    _______ , KC_LCTL , KC_LSFT ,       KC_HOME , KC_UP   , KC_PGDN , KC_END  , KC_GRV
  )
};
