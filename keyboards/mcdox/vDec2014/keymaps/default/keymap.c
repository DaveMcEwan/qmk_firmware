...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_mcdoxDec2014(
    ...
    KC_BSPC , KC_SCLN , KC_Q    , KC_J    , KC_K    , KC_X    ,
    KC_GRV  , KC_HOME , KC_PGDN , KC_PGUP , KC_END  ,
          ...
          KC_RBRC , KC_D    , KC_H    , KC_T    , KC_N    , KC_S    , KC_MINS ,
                    KC_B    , KC_M    , KC_W    , KC_V    , KC_Z    , KC_RCTL ,
  ...
  LAYOUT_mcdoxDec2014(
    ...
    _______ , _______ , _______ , _______ , _______ ,
          ...
          _______ , _______ , KC_BTN1 , KC_BTN3 , KC_BTN2 , _______ , _______ ,
                    _______ , KC_WH_L , KC_WH_U , KC_WH_D , KC_WH_R , _______ ,
  ...
  LAYOUT_mcdoxDec2014(
    ...
    KC_RCTL , KC_Z    , KC_V    , KC_W    , KC_M    , KC_B    ,
    KC_BSLS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT ,
          ...
          KC_DEL  , KC_I    , KC_U    , KC_E    , KC_O    , KC_A    , _______ ,
                    KC_X    , KC_K    , KC_J    , KC_Q    , KC_SCLN , KC_BSPC ,
